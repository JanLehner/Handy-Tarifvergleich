...
export function loadOffer() {
    ...
    styleHolder.innerHTML =
        '<link rel="stylesheet" href="./Stylesheets/offersStyle.css"></link>'
...
c0.199-0.982,0.291-1.992,0.291-2.986C385.063,227.715,383.438,223.764,380.59,220.931z"></path>
            ...
            addOfferCard.innerHTML = `<a class="flexbox btn btnAdd" id="addOfferBtn"><svg class="plusBtnSVG" fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
